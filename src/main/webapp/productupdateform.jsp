...
<body>
	...
	<div class="container">
		...
		<div class="content">
			<form action="ProductUpdate?id=<%=pvo.getId() %>" method="POST">
				<div class="user-details">
					<div class="input-box">
						<span class="details">Product Name</span> <input type="text"
							name="pname" placeholder="Enter your product" value="<%=pvo.getProductname() %>" required>
					</div>
					<div class="input-box">
						<span class="details">Price</span> <input type="number"
							name="price" placeholder="Enter the price of the product" value=<%=pvo.getPrice() %>
							required>
					</div>
					<div class="input-box1">
						<span class="details">Product Description</span>
						<textarea id="" cols="30" rows="10" name="pdescription" required><%=pvo.getPdescription() %></textarea>
					</div>
				</div>
